...
namespace Shesha.CRM.Common.Authorization
{
    /// <summary>
    /// CRM Permission checker
    /// </summary>
    public class CRMPermissionChecker : ICustomPermissionChecker, ICRMPermissionChecker
    {
        ...
        /// Default constructor
        /// </summary>
        public CRMPermissionChecker(IRepository<Person, Guid> personRepository, IRepository<ShaRoleAppointedPerson, Guid> rolePersonRepository, IRepository<ShaRoleAppointmentEntity, Guid> appEntityRepository)
        {
