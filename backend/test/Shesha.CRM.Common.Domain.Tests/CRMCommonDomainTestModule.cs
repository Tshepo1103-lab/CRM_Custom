...
using Shesha.CRM.Tests.DependencyInjection;
using Shesha;
...
namespace Shesha.CRM.Common.Tests
{
    [DependsOn(
        typeof(CRMModule),
    ...
    public class CRMCommonDomainTestModule : AbpModule
    {
        private string ConnectionString;

        public CRMCommonDomainTestModule(SheshaNHibernateModule nhModule)
        {
